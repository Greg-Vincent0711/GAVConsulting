  ...
  return (
    <>
      <div className="z-40 absolute flex flex-col items-center justify-center text-white last:justify-end mt-8 sm:mt-0">
        <h1 className="text-[3rem] sm:text-[10rem] md:whitespace-nowrap ">
          GAV Consulting
        </h1>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen w-screen">
        ...
        <div className={visible ? "visible" : "invisible"} ref={mainRef}>
          <p className="text-3xl md:text-4xl leading-relaxed mt-5 max-w-[80vw] pl-10">
            G.A.V. Consulting offers a range of services aimed at enhancing our
            clients' businesses based on their unique objectives. Whether our
            clients are associated with government, non-profit, or for-profit
            entities, we possess the expertise required to assist their
            organizations in attaining various goals. These goals may involve
            financial improvements, performance enhancements, or other
            objectives.
          </p>
